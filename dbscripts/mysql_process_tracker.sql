...
(
	...
	constraint dataset_type_lkup_dataset_type_uindex
		unique (dataset_type)
)
...
(
	...
	constraint extract_tracking_fk04
		foreign key (extract_filetype_id) references extract_filetype_lkup (extract_filetype_id),
...
(
	...
	constraint cluster_process_fk01
		foreign key (cluster_id) references cluster_tracking (cluster_id),
...
(
	...
	constraint process_target_object_fk02
		foreign key (target_object_id) references source_object_lkup (source_object_id)
);
